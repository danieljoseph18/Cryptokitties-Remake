// File for fetching all the cats from smart contract 
// into the catalogue
...
function renderCat(dna, id) {
    ...
    earColor(dna.earsColor, id)
    eyeVariation(dna.eyesShape, id)
    decorationVariation(dna.decorationPattern, id)
    patternColor1(dna.decorationMidcolor, id)
    patternColor2(dna.decorationSidescolor, id)
